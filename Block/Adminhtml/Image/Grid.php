...
namespace Intarmour\ImageClean\Block\Adminhtml\Image;
...
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    /**
     * @var \Intarmour\ImageClean\Model\imageFactory
     */
     ...
     * @param \Intarmour\ImageClean\Model\imageFactory       $imageFactory
    ...
    public function __construct(
        ...
        \Intarmour\ImageClean\Model\ImageFactory $ImageFactory,
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            ...
            array(
                'header' => __('Image'),
                'index' => 'value',
                'renderer' => '\Intarmour\ImageClean\Block\Adminhtml\Image\Grid\Renderer\Image',
            )
        );
        ...
        $this->addColumn('action', array(
            ...
            'renderer' => 'Intarmour\ImageClean\Block\Adminhtml\Image\Grid\Renderer\Action',
            'index' => 'value_id',
        ));
    ...
    /**
     * @param \Intarmour\ImageClean\Model\image|\Magento\Framework\Object $row
     *
     * @return string
     */
